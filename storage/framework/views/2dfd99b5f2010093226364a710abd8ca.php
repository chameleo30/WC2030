			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">	
						...
						<p>Chez <a class="libelle" href="/index"><?php echo e(config('app.name')); ?></a>, nous sélectionnons avec soin des maillots de football authentiques et de qualité, afin d’offrir aux supporters le meilleur en matière de style, de confort et de passion, sans compromis.</p>
					</div>
				</div>
			</div>
        	...
        	<div class="row clearfix">
            	...
            	<div class="image-column col-lg-6">
                	<div class="image">
                    	...
                    	<img src="assets-0/img/products/<?php echo e($produit_solde->photo); ?>" alt="">
                    </div>
                </div>
                <!--Content Column-->
...
Ne manquez pas cette chance de porter fièrement vos couleurs marocaines et vivre la passion du football !</div>
					...
					<button class="cart-btn add-to-cart" data-id="<?php echo e($produit_solde->id); ?>"><i class="fas fa-shopping-cart"></i>Ajouter au Panier</button>
                </div>
            </div>
        </div>
    </section>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-12">
					<div class="abt-text">
						...
						<h2>l’aventure <span class="orange-text"><?php echo e(config('app.name')); ?></span></h2>
...
Nous plaçons la qualité, l’authenticité et le confort au cœur de nos priorités afin de proposer des maillots de football soigneusement sélectionnés, conçus pour accompagner chaque supporter dans les moments forts du jeu.</p>
						...
						<p>Notre objectif est de rendre chaque expérience avec <?php echo e(config('app.name')); ?> simple, fluide et mémorable.
Nous croyons que porter un maillot, c’est bien plus qu’un choix vestimentaire : c’est vivre la passion.</p>
	...
	<!-- end logo carousel -->
	<?php echo $__env->make('partiels.chat', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</html><?php /**PATH C:\Users\AMAHANE\Documents\ABDO\coupe_du_monde_2030\resources\views/index.blade.php ENDPATH**/ ?>
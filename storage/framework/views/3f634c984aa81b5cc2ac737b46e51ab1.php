                ...
                <div class="main-menu-wrap">
                    ...
                    <nav class="main-menu">
                        <ul>
                            ...
                            <li class="cart-count"><a class="shopping-cart" href="/cart"><i class="fas fa-shopping-cart"></i><?php echo e(count(session('cart', []))); ?></a></li>
                            ...
                            <li class="mobile-user"><a style="padding: 8px;" href="/profile">
                                <img src="assets-0/img/clients/<?php echo e(session('client')->photo); ?>" alt="Profile Image" class="rounded-circle custom-profile-img">
                            </a></li>
...
</script><?php /**PATH C:\Users\AMAHANE\Documents\ABDO\coupe_du_monde_2030\resources\views/partiels/menu.blade.php ENDPATH**/ ?>
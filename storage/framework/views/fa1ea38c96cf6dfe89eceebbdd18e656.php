            ...
            <div class="container-fluid py-4">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <form class="card" method="Post" action="/ajouterProduit" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                          <div class="col-md-6 mb-4 mt-2">
                            <div class="form-group">
                              ...
                              <input name="designation" class="form-control form-control-lg" type="text" value="" required>
...
unset($__errorArgs, $__bag); ?>
                          ...
                          <div class="col-md-6 mb-4 mt-2">
                            <div class="form-group">
                              ...
                              <input name="photo" class="form-control form-control-lg" type="file" required>
...
unset($__errorArgs, $__bag); ?>
                          ...
                          <div class="col-md-6 mb-4 mt-2">
                            <div class="form-group">
                              ...
                              <input name="prix" class="form-control form-control-lg" type="text" value="" required>
...
unset($__errorArgs, $__bag); ?>
                          ...
                          <div class="col-md-6 mb-4 mt-2">
                            <div class="form-group">
                              ...
                              <input name="unite" class="form-control form-control-lg" type="text" value="" required>
...
unset($__errorArgs, $__bag); ?>
                          ...
                          <div class="col-md-6 mb-4 mt-2">
                            <div class="form-group">
                              ...
                              <input name="stock" class="form-control form-control-lg" type="number" value="1" min="1" required>
...
unset($__errorArgs, $__bag); ?>
                          ...
                          <div class="col-md-12 mt-2">
                            <div class="form-group">
                              ...
                              <input name="description" class="form-control form-control-lg" type="text" value="" required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        ...
        document.getElementById('a-link-02').classList.add('active');
    </script>
  </body>
</html>
<?php /**PATH C:\Users\AMAHANE\Documents\ABDO\coupe_du_monde_2030\resources\views/dashboard/addProductForm.blade.php ENDPATH**/ ?>
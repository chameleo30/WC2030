...
<body>
			...
			<div class="row">
				<div class="col-lg-7">
					<div class="featured-text">
						<h2 class="pb-3">Pourquoi <span class="orange-text"><?php echo e(config('app.name')); ?></span></h2>
						<div class="row">
							<div class="col-lg-6 col-md-6 mb-4 mb-md-5">
								<div class="list-box d-flex">
									...
									<div class="content">
										...
										<p>Nous nous engageons à livrer vos produits directement chez vous, rapidement et en toute sécurité.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 mb-5 mb-md-5">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3>Meilleur prix</h3>
										<p>Nous garantissons des prix compétitifs tout en maintenant la qualité de nos produits.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 mb-5 mb-md-5">
								<div class="list-box d-flex">
									...
									<div class="content">
										...
										<p>Nous offrons des options d'emballage sur mesure pour répondre à vos besoins spécifiques.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6">
								<div class="list-box d-flex">
									...
									<div class="content">
										...
										<p>Notre politique de remboursement est simple et rapide pour assurer votre satisfaction totale.</p>
									</div>
								</div>
							</div>
						</div>
	...
	<script>
		document.getElementById('about').classList.add('current-list-item');
	</script>

</body>
</html><?php /**PATH C:\Users\AMAHANE\Documents\ABDO\coupe_du_monde_2030\resources\views/about.blade.php ENDPATH**/ ?>